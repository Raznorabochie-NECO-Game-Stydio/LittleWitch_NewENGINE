...
label chapter1:
    ...
    e "Безымянная планета, затерянная в тени газового гиганта - колоссальной громады вечных бурь, нависшей над ней словно скала,"
    e " протянув свои прекрасно-изящные кольца. "
    ...
    if Cha_01 == 1:
        ...
        e "{i}В бесконечном числе миров, где каждая звезда есть отдельный мир, есть нечто уникальное и неповторимое...{/i} "
        e "{i}но все эти миры находятся под влиянием единых законов природы лежащих в глубине основы мироздания. {/i}"
        e "{i}И все это вместе называется вселенной. {/i}"
        e "{i}Но нет, ни одного из миров, который можно было бы назвать «моим», {/i}"
    
        scene bg0101 with dissA
    
        e "{i}потому что у каждого есть свое место в космосе и свои звезды; {w=1}я сама не существую {/i}"
        e "{i}– но где-то там во всем этом находится мое сердце... {/i}"
    
        scene bg0109 with dissA
    
        e "{i}Это непостижимо для человеческого ума...  {/i} "
        e "{i}Здесь все происходит одновременно {w=1}– но по-разному для каждого.{/i} "
        e "{i}В этой вселенной нет вечности или ничего похожего; оно никогда нельзя остановить во времени…{/i}"
