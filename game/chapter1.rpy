...
label chapter1:
    ...
    centered "{color=#ff0000}{b}{size=+8}The Little Witch{/size}{/b}{/color}"

    centered "{color=#d16f6a}{i}Все имена, названия городов, стран, даты и прочие критерии изменены в соответствии с чьей-то совестью. {/i}{/color}"
    centered "{color=#d16f6a}{i}Все совпадения с реальным миром, случайные или намеренные, {/i}{/color}"
    centered "{color=#d16f6a}{i}являются всего лишь одним из бесчисленного множества вариантов развития событий, {/i}{/color}"
    centered "{color=#d16f6a}{i}существующих в многообразии миров Мультивселенной. {/i}{/color}"
    centered "{color=#d16f6a}{i}Мы не призываем никого к совершению противозаконных или аморальных действий, {/i}{/color}"
    centered "{color=#d16f6a}{i}предупреждаем об опасности необдуманных экспериментов со своим сознанием {/i}{/color}"
    centered "{color=#d16f6a}{i}и осуждаем немедицинское употребление любых наркотических и психоактивных веществ. {/i}{/color}"
    centered "{color=#d16f6a}{i}Аминь.{/i}{/color}"
    ...
    centered "{color=#ff0000}{b}{size=+8}Глава 01. Сон Страны Грёз{/size}{/b}{/color}"
    ...
    e "{i}Она вынырнула из постели и выбралась в окно - там ждала её судьба.{/i}"
    ...
    e "{i} Тёмным был путь, но сверкала звезда.{/i}"
    e "{i}Горела в ночи и манила в пути безграничных дорог, причудливых снов и невозможных приключений.{/i} "

           ## Сцена 002
           ## переход на черный кадр через эффект перехода dream
           ##
           ##Менаеться музыкалный трек общего канала. предыдущий затухает через fadeout 1.0. Включается музыкалный трек общего канала с fadein 1.5, Т.Х. музыкального трека - тихий спокойный эмбиент с каплами или журчанием воды, создающий атмосферу текущей воды. музыкальная тема "водного мира"
           ##
           ##
    ...
    #play music "" fabein 1.5
           ...
           ## общий план, космос, на среднем плане планета газовый-гигант, живописная, с множеством завихрений циклонов и антициклонов, с колцами, видны ее несколько других спутников, в дали из-за края планеты-гиганта тускло светит звезда, камера опускается вниз(скролинг кадра с верхнего края картинки на нижний край), ближный план кадра появлается поверхност планеты спутника покрытого полностью водным пространством, и затянутая облаками.  
    ...
    e "Мир без названия, снежный мир, холодный мир."
    e "Под чёрными небесами несётся твердыня. "
    e "Огромный, скованный льдом живой океан." 
    e "Он составляет этот безымянный мир, и только пара скальных островов вздымается из чёрных бушующих вод его. "
    e "Безымянная планета, затерянная в тени газового гиганта - колоссальной громады вечных бурь, нависшей над ней словно скала, протянув свои прекрасно-изящные кольца. "
    ...
    $ renpy.pause(7.0) 
           ...
           ## Сцена 004
           ## кадр менаеться через переход diss. Смотровая плащадка ядерного маяка, кадр выстроен таким образом чтобы в левой его части была видна стена сделанная из плит черно-уголного металла, на стене на одной из плит нанесена граффити ядра реактора цитаденли Алянса, а так же различное оборудования и приборы освещения (визуальные отсылки на Алянс из Half-laif2), на дальнем плане виден двух секционый сфетовор направленный параллельно горизонту, (анимация периодического мигания, красного света в периоде 0,5 и 1,5 секунд, нижней секции). Сама плащадка выполненна из темного полупрозрачного стекла через которого виднеються силовые элементы конструкции и расположенное далеко внизу поверхность штормового океана. так же океан виден в правой части кадра вместе с облачностью и звездным небом. площадка огорожена металическими поручнами.   
           ## Ближный план.
           ## по середине кадра спрайт МВ, средний, на ней красный шарф и накинут полный комплект плащ. вырожения лица нейтральное, возле головы анимация ноты.  
           ## дополнытельные эффекты: анимированные бризги воды, ввиде моросы или дождя.  
    ...
    e "У неё было множество имён, {w=1} но не одного настоящего, и множество прозвищ, "
    e "но не одного истинного, {w=1} принадлежащего только ей одной… "
    ...
    e "И даже оно не одно: {w=1} их три. "
    e "Одно - маленькое и белое, {w=1} два других – больше: оранжевое и красное."
    e "...."
    ...
    e "С башни старого каменного маяка глазами температуры сна мира она смотрит вверх на парящую луну в зените небосвода,"    
    e " и ещё несколько лун серпиками виднеются в сумрачной дали. "
    
    $ renpy.pause(2.0)
    #play sound "Zvuki/wind-05.mp3" fadein 0.5
    #$ renpy.music.set_volume (0.3, .5, channel = "nature")

    e "И маленькое белое солнышко, едва освещающее этот мир. "
    e "Мир из планет и спутников водит бесконечный хоровод вокруг маленькой умирающей звезды, а сама звёздочка вокруг двух других вращающихся солнц,"

    #stop nature fadeout 1.5
    $ renpy.pause(2.0)

    e " и эти другие солнца согревают её по очереди. "
    ...
    e "Но каждые тысячу оборотов вокруг звезды мир на планете океана превращается в маленький белый комочек, от которого отдаляются все звёзды, кроме маленькой. "
    ...
    e "Зима уже недалеко, и океан вот-вот покроется льдом до самого горизонта. "
    
    e "С верхней смотровой площадки при яростном свете факела термоядерного маяка, что освещает мир ночью, "

    #play sound "Zvuki/turbine_loop_1.wav" fadein 0.5
    
    e "создавая маленькое солнце на своей вершине, невозможно будет рассмотреть край белой скорлупы, сковавшей планету, вплоть до очередного лета. "

    #play sound "Zvuki/se-gale.wav" fadein 0.5

    e "Вырабатывая термоядерную энергию."
    
    #вставит фон радиомачты
    
    e "Старый Маяк непрерывно посылает короткие радиосигналы в космос:"
    ...
    e "Разносилась по мертвому бездонному космосу."
    e "Безмолвный крик, бездны миров."
    ...
    e "Бушующие ураганы короткого лета, истрепавшие прибрежные пески, пройдут,"
    ...
    e "уступив холодным ветрам, дующим с горизонта. "
    ...
    e "Но зимой он становится тихим, спокойным и умиротворённым, и кажется, что вся планета засыпает, погружаясь в ледяной сон разума. "
    ...
    e "Шум прибоя доносятся снизу, волны - гигантские громады мрачной воды - разбиваются об острые скалы, оставляя после себя облака мелкой ледяной взвеси,"
    ...
    e " иногда долетающей чуть ли не до смотровой площадки. "
    ...
    e "Маленькой ведьме казалось, что и жизнь - и есть океан,"
    e " такой же бушующий, такой же переменчивый и непредсказуемый. "
    ...
    e "Кинув очередной взгляд в мрачный туманный горизонт, она застыла, как будто кого-то ждала, надеялась, что вот-вот на горизонте появится корабль. "
    ...
    e "Вдохнув морозный соленый воздух и закутавшись потеплее в широкий шарф, обмотанный вокруг её шеи, и накидку,"
    ...
    e "она резко развернулась на каблуках шнурованных сапог."
    ...
    e "Он развивал её белые будто снег волосы, заплетенные в косу, и закрепленной заколкой в виде бабочки. "
    ...
    e "Вот она уже спускалась по внутренней винтовой лестнице, являющейся частью стены, словно резьба в винте."
    ...
    e "Шум её шагов причудливым сюрреалистическим эхом разливался по внутренним помещениям маяка. "
    ...
    e "Спускалась она, уже не придерживаясь шершавой стены. "
    ...
    e "Через минуту она открыла скрипучую дверь и вышла на каменный утес."
    ...
    e "Скалистый берег, мрачный туманный утёс маяка, старая хижина, виднеющаяся в отдалении, "

    scene bg0036 with diss
    

    e "промерзающая в лютые зимы и подпёртая бревнами с покосившейся стороны,"
    e " еле охраняемая ветхой протекающей крышей"
    e "- вот и всё, что оставалось в бесконечной ледяной пустыне этого мирка. "
    ...
    e "Петляя среди камней, утыканных вокруг, словно зубы древнего чудовища, "
    e "направилась к своему скромному жилищу,"
    e "Маленькая ведьма шагами, мерившими тысячелетия, шла вперёд."
    ...
    e "Этот дом был каменный."
    e "Сейчас вокруг него стыл сумрак ночи. "
    e "Странным казалось в нём всё, и в то же время - всё было обычным. "
    e "Словно кто-то взял и ковырнул её воспоминания и детские мечтания,"
    e "после чего воплотил их в камне, не став его обтёсывать, но обложил каким-то таинственным заклятием "
    e "и перенёс назад во времени - так, чтобы когда маленькая ведьма его нашла, дом выглядел старым,"
    ...
    e "Озябшими пальцами, подложив пару поленьев в догорающие угли и подув на них,"
    e "чтобы едва заметные язычки пламени принялись лизать древесину,"
    ...
    e "она поставила чайник на металлическую решётку кипятиться. "
    ...
    e "В хижине было не теплее, чем на улице, поэтому она поёжилась,"
    ...
    e "сидя вплотную к огню и дожидаясь, пока вода в чайнике не вскипит."
    ...
    LW "{i}- Термодинамическое равновесие!{/i} "
    ...
    e "и единственным источником света в комнате, кроме алых бликов от огня в печке, была маленькая масляная лампадка."
    ...
    e "Тем временем, ведьма заварила травяной чай из собранных душистых, приторных трав,"
    e "которые она нашла и собрала за лето, и налила себе."
    ...
    e "Воспоминания по цветущим садам Азатота, где росли медовые деревья с пурпурными листьями и чудесными сладостными плодами... "
    ...
    e "спустившись с неба в мыльном пузыре наделенного разумом корабля-оболочки, "
    ...
    e "Когда-то Маленькая ведьма жила в причудливом мире,"

    scene bg0061 with dissA

    e " на опушке магического леса чудес, с пурпурными резными листьями"
    e "и стелящимся в корнях синеватым студнем с красивыми язычками будто пламени,"
    e " в уютном особняке в западном стиле с башенкой для наблюдения звезд."
   
    scene bg0062 with dissA


    e "По вечерам она любила, укрывшись в клетчатый плед, разглядывать россыпи звезд на черном куполе небес, "
    e "собирающихся в яркие неповторимые созвездия, " 
    e "то тут, то там окрашенные в царственные облака межзвездного газа, сидя на крытом крылечке своего дома,"
    e "неспешно потягивая сладкое вино из глиняной кружки. "
    ...
    e "Любила смотреть на Иггдрасиль."
    e "Огромное великое Древо Жизни, соединяющего миры."
    e "Иггдрасиль - висящий в огромном мыльном пузыре, на орбите планеты, с корнями, уходивщими в космос, "
    e "которому поклоняются как даровавшему жизнь и мудрость. "
    e "Его изумрудная листва блистала каплями росы, отражая свет, источая гротескные видения снов непостоянных форм, "
    ...
    e "а гигантский необхватный ствол покрытый мхом и грибными наростами чаг, "
    e "источавшими призрачный свет, разрастался раскидистыми ветвями, "
    e "на которых блестели хрустальные грозди миров, плывущие в грезах мироздания. "

    scene bg0068 with diss

    e "На тёмной, висящей неподвижно луне, рядом с древом, были страшные высокие башни из чёрного металла, древнего града,"
    e "построенного и покинутого обитателями не подающейся разуму древности, Великими Драконами в начале всех начал. "
    ...
    e "где обитали страшные и жуткие создания."
    e "Там не были властны понятия пространства и времени,"
    e "оттуда берется магия и время, "
    
    show DRC at Position(xpos = 900, ypos = 350, xanchor = 0.5, yanchor = 0.5) onlayer sloi04 with teleport


    e "там обитают Великие Драконы - вечные странники междумирья. "
    e "Иногда, если присмотреться, то можно на вечно черной поверхности различить происходящие время от времени вспышки и сияния. "
    ...
    e "Так же говорят, что когда-то, давным давно, там жила настоящая Ведьма, "

    scene bg0071 with dissA

    e "присматривающая за мирами, но покинувшая свой дом,"
    ...
    e "Где находиться «Звездный Храм»."
    ...
    e "Плохие и странные, загадочные и манящие, мистические и фантастические."

    scene bg0082 with dissA

    e "В них Маленькая Ведьма оказывалась в разных, не похожих друг на друга местах, наблюдая и общаясь с сущностями этих странных миров. "
    e "Маленькая Ведьма боялась этих снов, и в то же время сны манили её, заволакивая в свои чарующие объятия."
    ...
    centered "{color=#d16f6a}{i}Измените своё восприятие мира - и он послушно изменится. Это основной закон магии,{/i}{/color} "
    centered "{color=#d16f6a}{i}и он недоказуем, но однажды испытавший на себе его действие более не поставит его реальность под сомнение.{/i}{/color} "
    ...
    e "Она была в них свободна и независима, но эта свобода была словно раскаленная игла. Она чувствовала, что постоянно теряет частичку себя в чужих снах. "
    ...
    e "Она погрузилась в бездну воспоминаний и сновидений, чему трудно, а может - и вовсе просто невозможно подобрать разумное определение,"
    ...
    e "плутая в лабиринтах смутных видений иллюзий, созерцая проплывающие перед её взором,"
    ...
    e "В своих тонких снах, чистых как горный лёд, она часто созерцаяла причудливые картины пейзажей. "
    ...
    e "И она же путешествовала и по другим мирам, знакомясь с разными живыми, разумными существами... "
    ...
    e "Ведьма знала, что стоит ей проснуться - всё распадется; сны не вечны и податливы,"

    scene bg0093 with dissA

    e "словно узор, рисуемый морозом на стекле, распадающийся лишь от лёгкого тёплого дуновения пробуждения."
    ...
    e "В сфере, не имеющие названий, в бесчисленные системы миров и солнц, "
    e "двигающихся с поразительной правильностью,"
    
    scene bg0101 with dissA
    
    e "где каждое светило является самостоятельным целым"
    
    scene bg0109 with dissA
    
    e " и в то же время частью целого одним из серебристых островов на сапфировом море, "
    ...
    e "Она мягкой походкой спустилась сначала с небольшого холма,"
    e "покрытого высокой травой, колышущейся от дуновения ночного ветерка, на которой поблёскивали большие капли воды,"
    e "оставшиеся после дождя. Дорога была усыпана студенистыми лужицами, собравшимися на серой земле под тонкими стеблями. "
    e "Потянув носиком, она поняла, что скоро будет гроза. "
    
    #scene bg057 with rightiss


    e "Затем шла вдоль дома на сваях, на берегу озера Хали с неестественно серебристо-белой водой. "
    e "Остановившись, замедлив бег и по инерции ещё пройдя несколько шагов,"
    e "Маленькая ведьма очутилась возле порога хижины. "
    ...
    e "Над дверью горел фонарик, освещая пядь земли внизу."
    e "Рядом вились ночные бабочки, порхавшие в нежном танце вокруг его света. "
    e "Их крылья уже были опалены его жаром, но они продолжали порхать возле огня. "
    ...
    e "Маленькая ведьма, словно не заметив их, спокойно вошла в хижину. "
    e "В непостижимых, тёмных покоях вне времени под глухую,"
    e "сводящую с ума жуткую дробь барабанов и тихие монотонные всхлипы проклятых флейт,"
    e "под чей мерзкий грохот и протяжное дудение медленно, "
    e "неуклюже и причудливо пляшут гигантские тени неведанных существ,"
    e "мрачные, безумные Иные боги, чей дух и посланник — ползучий хаос"
    e "Минуя запредельные бездны,"
    e " оставляя позади звезды и материальные пространства"
    e "и метеором несясь сквозь кромешный хаос к непостижимым темным покоям вне времени."
    e "В кипящем и огненном центре Всего на своем черном троне восседает женщина. "
    ...
    e "Её одежда была не поддающейся человеческому описанию, по ней плыли звёзды и галактики."

    #show HM s01 at right onlayer xra with dissolve

    e "А на голове сверкала диадема."
    ...
    e "Женщина еле заметно улыбнулась, поднимая на неё взгляд глубоких глаз, которым доступна мудрость прожитых времен."
    ...
    LW "- Наверное… {w=1} Я пришла потому, что я хочу больше узнать про магию."

    HM "- И что ты хочешь, чтобы я рассказала тебе? "

    e "Сказала Наставница, протягивая ей руку и приглашая себе поближе, на её запястье сверкали радужные четки, словно гирлянды миров."

    LW "- Как стать настоящей Ведьмой?"

    HM "- Как ты знаешь, "

    HM "магию Ведьмы очень условно можно разделить на два круга внешний и внутренний. "

    HM "Можно сказать, что магия внешнего круга – это искусство изменения мира путем прямого воздействия на окружающее,"

    HM "а магия внутреннего круга – посредством внутренних ментальных тренировок и изменений процессов сознания. "
    ...
    LW "Я хочу понять, реален ли мир, который окружает меня..."

    HM "- Любопытный вопрос..."

    HM "Ответ... {w=1} Подобный ответ является лишь ментальной установкой, на которой базируется искусственная вера "

    HM "и соответствующая ей внутренняя реальность игры, игры с самой собой."

    LW "- А какой же ответ на самом деле? "

    e "Тогда поинтересовалась Маленькая ведьма, с любопытством смотря на наставницу, наклонив голову на плечо."

    HM "- Единственный честный ответ, который может быть дан"

    HM " это: «- Внутри меня есть нечто, что побуждает меня следовать этому пути». "

    HM "Прислушайся к себе и ощути в себе это «нечто». "

    e "Тогда посоветовала Наставница своей ученице."

    LW "- Это «Нечто», существующее, и есть то, что находится во внутреннем круге магии?"

    HM "— Почему же ты не можешь тогда стать ведьмой? Когда у тебя все лежит на поверхности?"
    ...
    HM "— Ведьма — не та, кто просто летает по небу, варит зелья,"

    HM "Все это ведьме абсолютно без надобности, так… "

    HM "так.. внешние атрибуты. Ведьму определяет место, где она живёт. "
    ...
    HM "Чтобы достигнуть этого пограничного состояния, те, кто желают стать ведьмой, используют различные техники. "

    LW "— Просто это в моей природе, "

    LW "Магия снов, и путешествие по ним."

    HM "— И, тем не менее, ты топчешься в последнее время на месте."

    LW "— Я постоянно практикуюсь. "
    ...
    e "Маленькая ведьма присела около её кресла, положив голову на подлокотник, и просяще посмотрела на Хранительницу"

    LW "- Расскажите, расскажите..."

    HM " - Ты знаешь все сказки мира, "

    HM "ты видишь во снах все миры, которые только существуют, и знаешь все их истории, "
    
    HM "которые были когда-либо придуманы. "

    HM "Я не могу рассказать того, что не существует и никогда не существовало."

    LW " - Тогда можете придумать свою историю?"

    LW "Так как вы выдумываете разные миры."

    e "Наставница о чем-то задумалась; Потом она произнесла:"
    ...
    e "Хранительница миров согласилась с мнением Маленькой Ведьмы"
    ...
    e "Маленькая ведьма не стала её будить, кинув на наставницу умиленный взгляд. "

    
    
    e "Она решила ещё ненадолго остаться в этом уютном домике и потом неслышно выскользнуть наружу, "
   
    e "не потревожив её сны."
