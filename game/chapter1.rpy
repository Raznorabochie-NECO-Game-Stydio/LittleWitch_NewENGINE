...
label chapter1:
    ...
    centered "{color=#d16f6a}{i}Ведьма измерений. Гуляющая сама по себе по фракталу древа миров мечтающая когда-нибудь приблизиться к Грани и обрести свое собственное Имя. {/i}{/color}"
    ...
    centered "{color=#ff0000}{b}{size=+8}Сон: Покой Льда, Песнь Океана{/size}{/b}{/color}"
    centered "{color=#ff0000}{b}{size=+8}Глава. Сон Страны Грёз{/size}{/b}{/color}"
    ...
    e "{i}Проснулась маленькая девочка в кровати тёплой{/i}"
    e "{i} и выглянула в окно - там горела январская холодная звезда. {/i}"
    ...
    e "Огромный, скованный льдом живой океан словно составляет этот безымянный мир, и только пара скальных островов вздымается из чёрных бушующих вод его. "
    ...
    e "Впрочем, она только учится у Наставницы, Хранительницы бездны миров, "
    ...
    e "– это надо было просто видеть. "
    #Мир преображался вокруг неё с каждым её шагом. 

    
    #Оно было достаточно крупное; 
    
    #Не помня, как она выбралась из той пещеры на поверхность, 
    #Маленькая Ведьма стояла на берегу солёного озера. Уже смеркалось. 
    #Холодало. Её голова кружилась в радужных пятнах, её тошнило. 
    ...
    #Перед ведьмой стояла женщина в черных одеяниях восточной жрицы со множеством ленточек 
    #и завитистым узором фрактала, вышитом на нем,в маске кицуне. 
    #Ее волосы были убраны под причудливым головным убором, 
    #напоминающем шапку арлекина с двумя свисающими оберегами на красных лентах. 
    # Концы этой шапки были похожи на ушки кошки или лисы. А позади нее развевались девять пушистых лисьих хвостов. 
    # Женщина держала руки в свободных рукавах сложенными на груди.
    
    
    
    
    #Маленькая Ведьма вскинула бровь, ей доводилась слышать эту историю.