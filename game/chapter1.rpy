...
# ════════════════════════════════════════════════════════════════════
#  СПРАВОЧНИК УПРАВЛЯЮЩИХ КЛЮЧЕЙ СПРАЙТА «МАЛЕНЬКАЯ ВЕДЬМА» (SLW)
# ════════════════════════════════════════════════════════════════════
#  Все состояния задаются через объект store.slw.
#  Общие правила для ЛЮБОГО слота:
#     slw.СЛОТ = None     → слой НЕ рисуется (по умолчанию)
#     slw.СЛОТ = "no"     → слой принудительно скрыт
#     slw.СЛОТ = "ключ"   → рисуется выбранный вариант
#
#  Ветер (для косы и волос):
#     wind_01 = 0   нет ветра (статичный кадр)
#     wind_01 = 1   слабый
#     wind_01 = 2   средний
#     wind_01 = 3   сильный
# ════════════════════════════════════════════════════════════════════
#
# ─────────────────────────────────────────────────────────────────────
#  slw.body — ПОЗА / РАКУРС ТЕЛА (базовый слой)
# ─────────────────────────────────────────────────────────────────────
#   "bodu_01_left"              "bodu_05_default"
#   "bodu_01_left_down"         "bodu_05_full_face"
#   "bodu_01_left_slant"        "bodu_05_full_face_slant"
#   "bodu_02_left"              "bodu_05_left"
#   "bodu_02_left_slant"        "bodu_05_left_down"
#   "bodu_02_default"           "bodu_06_default"
#   "bodu_02_left_down"         "bodu_06_left"
#   "bodu_03_default"           "bodu_06_left_down"
#   "bodu_03_left_down"         "bodu_06_left_slant"
#   "bodu_03_full_face"         "bodu_07_default"   (лицо уже на спрайте!)
#   "bodu_03_left_down_slant"   "bodu_08_default"
#   "bodu_04_default"           "bodu_08_left"
#   "bodu_04_left_down"         "bodu_08_left_down"
#   "bodu_04_full_face"         "bodu_08_left_slant"
#   "bodu_04_full_face_slant"   "bodu_09_default"
#                               "bodu_09_left"
#                               "bodu_09_left_down"
#                               "bodu_09_left_slant"
#                               "bodu_12_base"
#                               "bodu_13_base"
#                               "default"  (запасное тело)
#
#   ВНИМАНИЕ: у тела "bodu_07_default" глаза/рот/брови/веснушки/плач
#   нарисованы прямо на спрайте, поэтому эти слоты отключены ("no").
#
# ─────────────────────────────────────────────────────────────────────
#  slw.eyes — ГЛАЗА
# ─────────────────────────────────────────────────────────────────────
#   "blink"                        ← ОСОБЫЙ: включает анимацию моргания
#   "eyes_norm_01" ... "eyes_norm_05"
#   "eyes_norm_blindfold_01" ... "eyes_norm_blindfold_04"
#   "eyes_left_norm_01"
#   "eyes_right_norm_01"
#   "eyes_left_norm_he_winks_01"
#   "eyes_right_norm_he_winks_01"
#   "eyes_norm_cray_01"
#   "eyes_norm_horror_01"
#   "eyes_norm_horror_02"
#   "eyes_norm_prizes_01"
...
#
# ─────────────────────────────────────────────────────────────────────
#  slw.mouth — РОТ (эмоция в тишине; при разговоре включается lip-sync)
# ─────────────────────────────────────────────────────────────────────
#   "norm_smail_01"  "norm_smail_02"  "norm_smail_03"  ("norm_smail_04" — в S2/S4/S5)
#   "norm_conversation_01" ... "norm_conversation_04"
#   "norm_surprised_01" ... "norm_surprised_04"
#   "norm_sour_01"  "norm_sour_02"  "norm_sour_03"
#   "norm_audacious_01"
#   "norm_language_01"
#   "default"   (нейтральный / закрытый рот)
#
#   Lip-sync (анимация рта при печати реплики) работает автоматически
#   для персонажа LW. Кадры берутся из групп:
#     гласные   → norm_surprised_*
#     согласные → norm_conversation_*
#     паузы     → default / norm_sour_01 / norm_smail_01
#
# ─────────────────────────────────────────────────────────────────────
#  slw.brov — БРОВИ (управляет одновременно слоями brov и brov2)
# ─────────────────────────────────────────────────────────────────────
#   "brov_surprised_01"
#   "brov_gloomy_01"
#   "brov_irritations_01"
#   "brov_sad_01"
#   "brov_angry_01" ... "brov_angry_06"
#   "default"
#
# ─────────────────────────────────────────────────────────────────────
#  slw.freckles — ВЕСНУШКИ / РУМЯНА
# ─────────────────────────────────────────────────────────────────────
#   "norm_01" ... "norm_06"
#   "norm_hatching_01"
#   "norm_blush_01"
...
#  slw.cry — СЛЁЗЫ / ПЛАЧ
# ─────────────────────────────────────────────────────────────────────
#   "cry_01"  "cry_02"  "cry_03"  "cry_04"
#   "default"
#
# ─────────────────────────────────────────────────────────────────────
#  slw.hair — ВОЛОСЫ (анимируются на ветру; набор зависит от тела)
# ─────────────────────────────────────────────────────────────────────
#   "h1"   ← статичный кадр (показывается без ветра)
#   "h2"
#   "h3"
#   Примечание: волосы рисуются всегда (через slw_hair_displayable),
#   конкретный набор кадров определяется выбранным slw.body.
#
# ─────────────────────────────────────────────────────────────────────
#  slw.hat — ШЛЯПА (одна переменная на заднюю + переднюю часть)
# ─────────────────────────────────────────────────────────────────────
#   "hat_01"
#   "hat_02"
#
# ─────────────────────────────────────────────────────────────────────
#  ОДЕЖДА / БЕЛЬЁ / АКСЕССУАРЫ
# ─────────────────────────────────────────────────────────────────────
#  slw.panties — ТРУСИКИ
#     "panties_white"
#     "panties_black"
#
#  slw.pantaloons — ПАНТАЛОНЫ
#     "pantaloons_long"
#     "pantaloons_short"
#
#  slw.top — ТОП / МАЙКА
#     "top_01"  "top_02"  "top_white"  "top_black"
#
#  slw.clothes — ВЕРХНЯЯ ОДЕЖДА (платье / ночнушка)
#     "nightie_01"
#     "dresses_01"
#
#  slw.exercise — ТРЕНИРОВОЧНЫЙ КОСТЮМ
#     "exercise_01"
#
#  slw.carset — КОРСЕТ
#     "Carset_01"
#
#  slw.gloves_left — ПЕРЧАТКА ЛЕВАЯ
#     "gloves_left_01"
#
#  slw.gloves_right — ПЕРЧАТКА ПРАВАЯ
#     "gloves_right_01"
#
#  slw.boots_left — САПОГ ЛЕВЫЙ
#     "boots_left_01"
#
#  slw.boots_right — САПОГ ПРАВЫЙ
#     "boots_right_01"
#
# ─────────────────────────────────────────────────────────────────────
#  ПОРЯДОК СЛОЁВ (снизу вверх):
#  hat → kassa → body → brov → freckles → eyes → cry → mouth →
#  hair → brov2 → hat_front → boots → бельё → топ → перчатки →
...
#     $ slw.panties  = "no"        # принудительно скрыть
#     $ wind_01      = 2
