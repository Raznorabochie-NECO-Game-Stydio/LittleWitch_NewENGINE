...
label chapter1:
    ...
    $ renpy.pause(7.0) 
           ...
           ## видна стена сделанная из плит черно-уголного металла, на стене на одной из плит нанесена граффити ядра реактора цитаденли Алянса, а так же различное оборудования и приборы освещения (визуальные отсылки на Алянс из Half-laif2), 
           ## на дальнем плане виден двух секционый сфетовор направленный параллельно горизонту, (анимация периодического мигания, красного света в периоде 0,5 и 1,5 секунд, нижней секции). 
           ## Сама плащадка выполненна из темного полупрозрачного стекла через которого виднеються силовые элементы конструкции и расположенное далеко внизу поверхность штормового океана. так же океан виден в правой части кадра вместе с облачностью и звездным небом. площадка огорожена металическими поручнами.   
           ## Ближный план.
    ...
    e "В прочем, она только учится у наставницы - хранительницы бездны миров... "
            ...
            ## задный фон менаеться через эффект diss, исчезает эффект бризг, и анимированная нота возле головы МВ. так же исчезает шум турбины через затухания fadeout 1.5
            ## на заднем фоне арнамент фрактала.
            ##
            ##
    ...
    e "- но ни одного истинного, {w=1} принадлежащего только ей одной… "
             ...
             ##задный фон менаеться через эффект dissolve, на инвертную цветов того же фона
    ...
    e "...."
            ...
            ##Длинный скроленг панорамы от нижнего края к верхнему. МВ стоит спиной к игроку на смотровой площадке ядерного мояка. 
            ##перед ней вид на бущующий океан звезды и облака, за которыми виден газовый-гигант с колцами. камера поднимается вверх, 
            ## демонстрируя звездное небо, другие спутники, в верхней части кадра, виден другой спутник планеты-гиганта в виде серпа на краю которого виден блеск от яркой звезды которую он затьмевает. 
            ##
    ...
    e "С башни старого маяка глазами температуры сна мира она смотрит вверх на парящую луну в зените небосвода,"    
    e " а ещё несколько лун серпиками виднеются в сумрачной дали. "
    ...
    e " и эти другие солнца согревают её по очереди. "
            ...
            ## дополнительные звуковые каналы - предыдущий звук турбины глющаться через fadeout 1.5, но появлаеться звук ветра.
    ...
    e "Долгая зимняя ночь, в которой царят холод и одиночество... "
            ...
            ## показываеться пейзаж обледенелого мира.
    ...
    e "Но пока его волны ещё бушуют. Гигантские громады мрачной воды разбиваются об острые скалы, "
    e "оставляя после себя облака мелкой ледяной взвеси. "
    e "Маленькая Ведьма наблюдает за их игрой с верхней смотровой площадки термоядерного маяка при яростном свете инжектора-факела, что освещает мир ночью," 
    ...
    e "Кинув очередной взгляд в мрачный туманный горизонт, она застыла. Казалось, будто она кого-то ждала - надеялась, что вот-вот на горизонте появится корабль. "
    ...
    e "Вдохнув морозный соленый воздух, Маленькая Ведьма закутавшись потеплее в плотную накидку и поправила свой широкий, расшитый белыми звёздами шарф."
    ...
    e "Ветер так и норовил растрепать её тяжёлую, закрепленную заколкой в виде бабочки косу, в которую были заплетены её длинные, белые словно снег волосы…"
    ...
    e "Словно кто-то взял и ковырнул её воспоминания из детские мечтаний - после чего воплотил их в камне. Но не стал обтёсывать, а обложил каким-то таинственным заклятием "
