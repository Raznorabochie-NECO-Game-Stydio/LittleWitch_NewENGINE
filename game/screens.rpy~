...
screen main_menu():
    ...
    imagemap:
        ground Movie(play="gui/main_menu/main_menu.webm")
        idle "gui/main_menu/menu_idle.png"
        hover "gui/main_menu/menu_hover.png"
        
        hotspot(1616, 84, 110, 100) action Start()
        hotspot(1622, 236, 106, 100) action ShowMenu("load")
        hotspot(1615, 382, 133, 140) action ShowMenu("preferences")
        hotspot(1605, 573, 155, 155) action ShowMenu("extra")
        hotspot(1637, 838, 135, 164) action Quit(confirm=True)
